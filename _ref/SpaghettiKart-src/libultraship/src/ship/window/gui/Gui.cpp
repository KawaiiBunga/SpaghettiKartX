...
void Gui::DrawMenu() {
    ...
    if (ImGui::IsKeyPressed(TOGGLE_BTN, false) || ImGui::IsKeyPressed(ImGuiKey_Escape, false) ||
        ImGui::IsKeyPressed(TOGGLE_PAD_BTN, false) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack, false)) {
        if ((ImGui::IsKeyPressed(ImGuiKey_Escape, false) || ImGui::IsKeyPressed(TOGGLE_PAD_BTN, false) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack, false)) && GetMenu()) {
            GetMenu()->ToggleVisibility();
        } else if ((ImGui::IsKeyPressed(TOGGLE_BTN, false) || ImGui::IsKeyPressed(TOGGLE_PAD_BTN, false) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack, false)) &&
                   GetMenuBar()) {
