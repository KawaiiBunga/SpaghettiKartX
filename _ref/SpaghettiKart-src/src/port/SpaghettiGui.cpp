...
void SpaghettiGui::DrawMenu() {
    ...
    if (ImGui::IsKeyPressed(TOGGLE_BTN) || ImGui::IsKeyPressed(ImGuiKey_Escape) ||
        ImGui::IsKeyPressed(TOGGLE_PAD_BTN) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack)) {
        if ((ImGui::IsKeyPressed(ImGuiKey_Escape) || ImGui::IsKeyPressed(TOGGLE_PAD_BTN) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack)) && GetMenu()) {
            GetMenu()->ToggleVisibility();
        } else if ((ImGui::IsKeyPressed(TOGGLE_BTN) || ImGui::IsKeyPressed(TOGGLE_PAD_BTN) || ImGui::IsKeyPressed(ImGuiKey_GamepadBack)) && GetMenuBar()) {
